import { bootStatisticsProbability } from "./js/boot-l1.js?v=hubfirst1";
...
function start() {
  bootStatisticsProbability({ manifest }).catch((err) => {
    console.error("[statistics-probability] boot failed", err);
