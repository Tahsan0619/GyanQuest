/**
 * Chemistry Lab Canvas 2D arena - layout-aware, hit-testable, resize-safe.
 */
...
export function createArena2D(canvas, theme = {}) {
 ...
 const rg = ctx.createRadialGradient(w * 0.5, h * 0.22, 16, w * 0.5, h * 0.38, w * 0.65);
 rg.addColorStop(0, "rgba(56,189,248,0.16)");
 ...
 const description = text || "2D chemistry animation stage";
 canvas.setAttribute("aria-label", description);
 const live = document.getElementById("chem-scene-live");
