...
export function mountSpeedDrill(host, cfg) {
 ...
 playScene(cfg.passScene || cfg.scene || "cleanMastery");
 host.innerHTML = `
 <div class="chem-card">
 ...
 playScene(cfg.scene || "cleanDrill", { prompt: chemLabState.prompt, flashColor: chemLabState.flashColor });
 host.innerHTML = `
...
export function mountMythCards(host, cfg) {
 ...
 playScene(cfg.scene || "cleanMyth", { myth: m.sceneMyth });
 host.innerHTML = `
