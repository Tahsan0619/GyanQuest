import { bootNetworkingInternet } from "./js/boot-l1.js?v=hubfirst1";
...
function start() {
  bootNetworkingInternet({ manifest }).catch((err) => {
    console.error("[networking-internet] boot failed", err);
