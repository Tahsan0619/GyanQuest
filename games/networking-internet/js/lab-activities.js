...
export function mountSpeedDrill(host, cfg) {
 ...
 playScene(cfg.passScene || cfg.scene || "packetMastery");
 host.innerHTML = `
 <div class="chem-card">
 ...
 playScene(cfg.scene || "packetDrill", { prompt: chemLabState.prompt, flashColor: chemLabState.flashColor });
 host.innerHTML = `
...
export function mountMythCards(host, cfg) {
 ...
 playScene(cfg.scene || "packetMyth", { myth: m.sceneMyth });
 host.innerHTML = `
