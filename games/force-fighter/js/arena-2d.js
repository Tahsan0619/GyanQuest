...
export function createArena2D(canvas, theme = {}) {
  ...
  function drawLabBackdrop() {
    ...
    rg.addColorStop(0, "rgba(251,191,36,0.14)");
  ...
  function setDescription(text) {
    const description = text || "2D force animation stage";
    canvas.setAttribute("aria-label", description);
    const live = document.getElementById("force-scene-live") || document.getElementById("chem-scene-live");
