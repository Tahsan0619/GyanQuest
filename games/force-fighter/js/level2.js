...
export const L2_META = {
 ...
 bdHook: "Bangladesh everyday: kick a light football vs shove a heavy drum - same idea as Push Power.",
 predict: {
 q: "Same push on a light crate and a heavy crate - who speeds up faster?",
 options: [
 "The heavier one always",
 "The lighter one (bigger a = F/m)",
 "Neither ever moves",
 ],
 ok: 1,
 },
...
function sub1_meet({ overlay, setCoach, completeSub }) {
 ...
 dwellMs: 4000,
 html: `<p><strong>Act 3:</strong> Big idea - <strong>a = F / m</strong> (or <strong>F = m · a</strong>).</p>`,
 },
 ],
 onDone: () => {
 mountQuiz(overlay, {
...
function sub2_watch({ overlay, setCoach, completeSub }) {
 setCoach("Watch the three pieces: Force, Mass, Acceleration - drag F and tap mass chips.");
 forceLabState.massKg = 100;
 forceLabState.heat = 0.35;
 mountForceDial(overlay, {
 scene: "pushSim",
 title: "Watch F, m, and a",
 html: `<p><strong>F</strong> - how hard you push (newtons). Drag the force handle.</p>
 <p><strong>m</strong> - tap 100 / 400 / 800 kg on the canvas.</p>
 <p><strong>a</strong> - how quickly velocity changes: <strong>a = F / m</strong>.</p>
 <p>They link as <strong>F = m · a</strong> (multiply - not divide).</p>`,
 goalText: "Goal: try at least two masses and set force ≥ 55%.",
 doneLabel: "I see F, m, a ▶",
 threshold: 0.55,
 startHeat: 0.35,
 axis: "x",
 ...
 cold: "Small F - tiny a",
 melting: "Building F…",
 liquid: "Strong F - a rises",
 simmer: "Peak F - watch a = F/m",
 },
 ...
 scene: "pushSim",
 title: "Check",
 q: "If you keep F the same but raise mass, acceleration…",
 opts: ["Gets smaller", "Gets bigger", "Stays identical", "Becomes infinite"],
 ok: 0,
 onDone: completeSub,
 });
 },
...
function sub5_sim({ overlay, setCoach, completeSub }) {
 ...
 scene: "pushSim",
 title: "Live F = m · a",
 html: `<p>Drag force on the canvas. Tap 100 / 400 / 800 kg. Watch a update live.</p>`,
...
function sub7_stretch({ overlay, setCoach, completeSub }) {
 setCoach("Stretch: truck, bike, sofa, rocket, elevator - tap canvas chips.");
 const modes = [
 ...
 <p class="drag-hint">Tap matching chips on the canvas (Truck / Bike / Sofa / Rocket / Elevator).</p>`,
 onDone: step,
 });
 }
 step();
...
function sub8_myths({ overlay, setCoach, completeSub }) {
 ...
 { title: "Add myth", claim: "F = m + a", truth: "F = m · a (multiply, don’t add).", sceneMyth: 2 },
