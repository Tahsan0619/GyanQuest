import { bootElectronicsRobotics } from "./js/boot-l1.js?v=hubfirst1";
...
function start() {
  bootElectronicsRobotics({ manifest }).catch((err) => {
    console.error("[electronics-robotics] boot failed", err);
