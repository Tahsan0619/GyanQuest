...
export const L1_META = {
  ...
  bdHook: "Bangladesh everyday: notice structure tags around you — then connect it to HTML House.",
  predict: {
    q: "Before we start — what do you think matters most in HTML House?",
    options: [
